            ...
            <div className='p-card p-card-1'>
              <div className='p-card-content'>
                ...
                <div className='lang-tags'>
                  ...
                  <button className='lang-tag firebase-tag'>Redux</button>
                  <button className='lang-tag mui-tag'>Syncfusion</button>
                </div>

                <div className='project-links'>
                  <a
                    href='https://github.com/FesoQue/Complete-React-Dashboard'
                    className='github'
                    target='_blank'
                    rel='noreferrer'
                  >
                  ...
                  <a
                    href='https://dbproject.netlify.app'
                    className='ext-link'
                    target='_blank'
                    rel='noreferrer'
                  >
